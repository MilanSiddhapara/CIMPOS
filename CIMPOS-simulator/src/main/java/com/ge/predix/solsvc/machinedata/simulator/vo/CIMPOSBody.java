...
public class CIMPOSBody {
	...
	private CIMPOSAttributesVO attributes;
	...
	public CIMPOSAttributesVO getAttributes() {
		return attributes;
	}

	public void setAttributes(CIMPOSAttributesVO attributes) {
